    if(document.getElementById("itext")) {document.getElementById("itext").value = getSavedValue("itext");  }  // set the value to this input
...
var AudioPlayer = (function() {
  ...
  function init(options) {
    ...
    downloadBtn    = player.querySelector('.ap__controls--download');
    ...
    downloadBtn.addEventListener('click', saveAs, false);
...
AP.init({
  playList: [
    {'icon': iconImage, 'title': 'Demo', 'file': 'https://chunk.lab.zalo.ai/a9f38fb0ece705b95cf6/a9f38fb0ece705b95cf6'}, 
  ]
});

/*
// TEST: update playlist
if(document.getElementById('addSongs')){
...
function update_pl(file_url){
    fileName = Date.now();
    AP.update([
    {'icon': iconImage, 'title': fileName, 'file': file_url},
  ]);
